...
1. Check the general content framing to replace last year with the current year.
...
4. **Validate Build:** After updating `data.yml`, run `npx gulp template` to ensure the HTML compiles correctly.
